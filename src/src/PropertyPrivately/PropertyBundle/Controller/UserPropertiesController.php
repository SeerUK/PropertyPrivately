...
class UserPropertiesController extends RestController
{
    ...
    public function getAction($id)
    {
        ...
        $assembler = $this->get('pp_property.resource_assembler.user_properties.get_assembler');
    ...
    public function postAction()
    {
        ...
        return $this->getPostResponse('pp_property_user_properties_get', array(
            'id' => $property->getId()
        ));
    }
    ...
    public function patchAction($id)
    {
        ...
        return $this->getPatchResponse('pp_property_user_properties_get', array(
            'id' => $property->getId()
        ));
    }
